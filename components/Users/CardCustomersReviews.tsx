...
const CardCustomersReviews = ({
  ...
  id,
  productId,
}: ProductReview & { currentUserId?: string }) => {
    ...
    <div className="px-8 py-7 border-2 rounded-3xl h-full  md:w-full min-w-[350px] ">
      ...
      <div className="">
        <div className="mb-3 flex items-center">
          <h5 className="text-xl font-bold  mr-1 whitespace-nowrap">
            {reviewerName}.
          </h5>
          <svg
            width="24"
        ...
        {editMode && (
          <div className="mt-4">
            <ReviewForm
              ...
              userId={userId}
              name={reviewerName}
              data={{ rating, comment, reviewerName, productId, userId }}
              mode="update"
              reviewId={id}
              onSuccess={() => {
                setEditMode(false);
